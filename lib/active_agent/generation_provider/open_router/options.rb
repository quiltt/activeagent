  ...
  module GenerationProvider
    module OpenRouter
      class Options < ActiveAgent::GenerationProvider::OpenAI::Options
        ...
        attribute :transforms # Array of strings
        attribute :models # Array of model strings for fallback
        ...
        delegate_attributes :data_collection, :enable_fallbacks, to: :provider
        ...
        # Override to include OpenRouter-specific parameters
        def chat_parameters
          deep_compact(super.merge(
