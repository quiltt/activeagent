...
module Integration
  module Ollama
    module Chat
      module CommonFormat
        # Note: Ollama's structured output documentation primarily references the deprecated `.format` parameter
        # from the legacy OpenAI Chat API. Current implementation relies on `response_format`, with feature
        # support delegated entirely to the underlying model.
        # @see https://docs.ollama.com/capabilities/structured-outputs#generating-structured-json
