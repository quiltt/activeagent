...
class ParameterizedTest < ActiveSupport::TestCase
  class TestAgent < ActiveAgent::Base
    generate_with :mock, model: "gpt-4o-mini", instructions: "You are a helpful assistant."
  ...
  test "processed_agent creates new agent instance with params" do
    generation = TestAgent.with(name: "Charlie", role: "admin").greet_user
  ...
  test "empty params work correctly" do
    generation = TestAgent.with({}).greet_user
